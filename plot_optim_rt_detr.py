...
with open("benchmark_results_rt_detr_r101.json", "r") as file:
    data = json.load(file)
...
plt.title(
    "Comparison of average FPS between RT-DETR and Optim RT-DETR on a NVIDIA A10 GPU\n using 'PekingU/rtdetr_r101vd' checkpoint."
)
plt.xticks(rotation=45)
plt.legend(title="Library")
plt.tight_layout()
plt.savefig("benchmark_results_rt_detr_r101.png", dpi=300)
...
plt.title(
    "Comparison of relative speedup between RT-DETR and Optim RT-DETR on a NVIDIA A10 GPU\n using 'PekingU/rtdetr_r101vd' checkpoint."
)
plt.xticks(rotation=45)
plt.legend(title="Library")
plt.tight_layout()
plt.savefig("benchmark_results_relative_rt_detr_r101.png", dpi=300)
